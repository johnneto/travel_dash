...
- **Places**: a sortable country table (days, trips, cities, first and last visit), top cities, most visited places (with Google Maps links), the geographic extremes, and a history of where you lived.
